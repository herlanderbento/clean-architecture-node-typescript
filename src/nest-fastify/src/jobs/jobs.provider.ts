// export namespace JOBS_PROVIDER {
//   export namespace REPOSITORIES {
//     export const JOB_IN_MEMORY_REPOSITORY = {
...
//     export const LIST_JOBS_USE_CASE = {
//       provide: ListJOBSUseCase.UseCase,
//       useFactory: (categoryRepo: CategoryRepository.Repository) => {
//         return new ListJOBSUseCase.UseCase(categoryRepo);
//       },
//       inject: [REPOSITORIES.CATEGORY_REPOSITORY.provide],
//     };
